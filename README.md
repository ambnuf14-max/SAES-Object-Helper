...
Готовую расстановку **сохраняешь в превью одной клавишей** (ПКМ, настраивается). Дальше — отдельное **меню серверных объектов** и всплывающая **нотификация «Установить на сервер?»**: ставишь всё на сервер по одному или пачкой, со сводкой и откатом по `Ctrl+Z`.
