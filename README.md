...
- **✏️ Режим редактирования (Edit)** — точная расстановка: перемещение, вращение по осям, **прижатие к поверхности** (snap), привязка к сетке, подсказки осей.
...
- **↩️ Undo / Redo** — полная история действий (`Ctrl+Z` / `Ctrl+Y`), включая откат установки на сервер.
- **⌨️ Гибкие хоткеи** — любую клавишу можно переназначить прямо в меню.
